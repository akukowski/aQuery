...
exports.default = {
    ...
    post: function post(url, data) {
        var _getXHR2 = getXHR("POST", url),
            xhr = _getXHR2.xhr,
            p = _getXHR2.p;

        xhr.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");

        xhr.send((0, _Ajax.serialize)(data));
...
var _weakMap = __webpack_require__(90);
...
var _Iteration = __webpack_require__(76);
...
var aQuery = function (_mixin) {
    (0, _inherits3.default)(aQuery, _mixin);

    function aQuery(nodes) {
        (0, _classCallCheck3.default)(this, aQuery);

        var _this = (0, _possibleConstructorReturn3.default)(this, (aQuery.__proto__ || (0, _getPrototypeOf2.default)(aQuery)).call(this));
    ...
    (0, _createClass3.default)(aQuery, [{
        key: 'get',
            ...
            return _regenerator2.default.wrap(function value$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            return _context.delegateYield(this.get(), 't0', 1);
    ...
    return aQuery;
}((0, _Mixin.mixin)(_Attributes2.default, _Iteration2.default, _Content2.default, _Events2.default));

exports.default = aQuery;
module.exports = exports.default;
...
function createElement(htmlTag) {
    ...
    var results = /<(.+)>/.exec(htmlTag);

    if (results && results[0]) {
        return document.createElement(results[1]);
    } else {
        throw new Error("Nieprawidłowy ag HTML");
    }
}
...
var _aQuery = __webpack_require__(71);

var _aQuery2 = _interopRequireDefault(_aQuery);

var _Check = __webpack_require__(28);

var _Element = __webpack_require__(72);
...
function init(param) {
    ...
    return _aQuery2.default.create(nodes);
}

(0, _Mixin.staticMixin)(init, _Ajax2.default);
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(8)(Function.call, __webpack_require__(60).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
